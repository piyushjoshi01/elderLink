...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-4 w-full p-4">
  ...
  <div className="p-6 bg-gray-100 flex flex-col items-center"> 
	...
	<p className="mt-2 text-gray-800 text-center">
  "Caregivers can assist with bathing, dressing, toileting, hygiene and other day-to-day personal care need"	</p>
  </div>
</div>


<div className=" p-8 bg-lime-700 rounded-lg shadow-lg">
    <h2 className="text-2xl text-center font-semibold mb-4 text-white">Elder Link Information</h2>
    <p className="text-lg text-center text-white">Welcome to ElderLink, your trusted companion for all your needs as you journey through life's later chapters. At ElderLink, we understand the importance of providing comprehensive support to seniors and their families, ensuring that every aspect of your care is centered around your individual needs and preferences.</p>
    <p className="text-lg text-center text-white mt-4">As a locally owned and operated agency, ElderLink prioritizes swift response times and offers a deeply personalized approach to caregiving. </p>
</div>
